...
- tag prevista para o estado final documentado: `epg-v1.15.4`;
...
`epgserver:v1.15.4-20260903`. Além das correções anteriores de EIT, simulador e
...
|---|---|
| EPG | `epg-stream`, imagem `epgserver:v1.15.4-20260903` |
