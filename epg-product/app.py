...
class Application:
    ...
    def catalog(self, source_id: str, force: bool = False) -> dict[str, Any]:
        ...
        return {
            ...
            "next_refresh_at": int(guide["fetched_at"] + GUIDE_CACHE_SECONDS),
            "cache_seconds": GUIDE_CACHE_SECONDS,
            "bytes": guide["bytes"],
