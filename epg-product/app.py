...
function toggleMonitorGuide(){monitorGuideExpanded=!monitorGuideExpanded;renderMonitor();if(monitorGuideExpanded&&!monitorGuide)loadMonitorGuide()}
...
render=function(){state.carriers=sortedCarriers(state.carriers||[]);renderWithCarrierOrder();applyCarrierSortHeaders()};
