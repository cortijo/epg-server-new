...
class GuideCache:
    ...
    def _persist_status(self, source_id: str, parsed: dict[str, Any]) -> None:
        ...
        status = {
            ...
            "next_refresh_at": fetched_at + GUIDE_CACHE_SECONDS,
        }
