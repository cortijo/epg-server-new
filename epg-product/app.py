...
class GuideCache:
    ...
    def get(self, source: dict[str, Any], force: bool = False) -> dict[str, Any]:
        ...
        try:
            ...
            with self.lock:
                self.errors[source_id] = {"message": str(error), "at": now_epoch()}
