...
O OMNIEPG 1.25.0 cadastra um NDS3306I e vincula uma portadora EPG a um `Output TS`. A sincronização consulta o estado atual antes de alterar e não remove inputs, programas ou PIDs alheios à operação.
